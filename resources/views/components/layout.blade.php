...
<head>
    ...
    <!-- Load Alpine with defer so it initializes after the document is available -->
...
<body class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
    <div class="pae-container" x-data="{ isSidebarOpen: false }">
        ...
        <!-- Top Navigation Bar -->
        <nav class="bg-white/80 backdrop-blur-md shadow-sm fixed top-0 left-0 right-0 z-30 border-b border-white/20">
